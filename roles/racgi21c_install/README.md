...
Summary
This playbook is for installing Oracle Grid Infrastructure 21c using ANsible playbook on Oracle Linux (7.5)
...
[root@oel75 ansible]# ansible-playbook oracleGInRAC21cR3.yml
...
TASK [racgi21c_install : display pre installation of Oracle GI software message] *********************************
ok: [192.168.56.102] => {
    "msg": [
        "This playbook is for installing Oracle RAC GI software 21c , started at 2019-09-19T13:42:02Z:"
    ]
}
ok: [192.168.56.103] => {
    "msg": [
...
TASK [racgi21c_install : create required directories] ************************************************************
...
TASK [racgi21c_install : Install NTP for cluster] ****************************************************************
ok: [192.168.56.103]
ok: [192.168.56.102]

TASK [racgi21c_install : Ensure NTPD is running and enabled] *****************************************************
ok: [192.168.56.102]
ok: [192.168.56.103]

TASK [racgi21c_install : copy grid 21c grid software response file to the target database server] ****************
ok: [192.168.56.102] => (item=gridsetup21c.rsp)
ok: [192.168.56.103] => (item=gridsetup21c.rsp)
...
TASK [racgi21c_install : Unpack Oracle 21c GI Software] **********************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : install cvu rpm from a local file] ******************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Transfer cvu file from ora-x1 to ora-x2] ************************************************
changed: [192.168.56.102 -> ora-x2]

TASK [racgi21c_install : install cvu rpm from a local file] ******************************************************
changed: [192.168.56.103]

TASK [racgi21c_install : Run cluster Verification Checks for CRS Installation] ***********************************
changed: [192.168.56.102]

TASK [racgi21c_install : Install Oracle 21c GI Software] *********************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Get the output log status] **************************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Output from Post GI Software Installation Check] ****************************************
ok: [192.168.56.102] => {
    "racgisoftinstall_log.stdout": "Successfully Setup Software with warning(s)."
}

TASK [racgi21c_install : Execute orainstroot.sh on the node1] ****************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Output from gisw_orainstroonode1] *******************************************************
ok: [192.168.56.102] => {
...
TASK [racgi21c_install : Execute orainstroot.sh on node2] ********************************************************
changed: [192.168.56.103]

TASK [racgi21c_install : Output from gisw_orainstroonode2] *******************************************************
ok: [192.168.56.103] => {
...
TASK [racgi21c_install : Execute root.sh on the first node] ******************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Get the logfile name on the first node] *************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Get the logfile information on the first node] ******************************************
changed: [192.168.56.102] => (item=logino.log)

TASK [racgi21c_install : debug] **********************************************************************************
ok: [192.168.56.102] => {
...
TASK [racgi21c_install : Execute root.sh on the second node] *****************************************************
changed: [192.168.56.103]

TASK [racgi21c_install : Get the logfile information on the second node] *****************************************
changed: [192.168.56.103]
...
TASK [racgi21c_install : Install Oracle 21c GI ConfigTools in Silent Mode] ***************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Get the logfile name ConfigTools] *******************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Get the logfile information for ConfigTools] ********************************************
changed: [192.168.56.102] => (item=logino.log)
...
ok: [192.168.56.102] => {
    "giexecfg.results[0].stdout_lines": [
        ...
        "sun.java.command = oracle.install.ivw.crs.driver.CRSConfigWizard -printtime ORACLE_HOME=/u02/app/19.3.0/grid -silent -executeConfigTools -waitforcompletion -skipStackCheck -responseFile /u02/stage/gridsetup21c.rsp -all",
        ...
        "oracle.installer.responseFile = /u02/stage/gridsetup21c.rsp",
        ...
        "\t\tOracle Grid Infrastructure 21c 19.0.0.0.0 ",
        ...
        "\t\tOracle Database 21c Multimedia Files 19.0.0.0.0 ",
        ...
        "\t\tOracle Database 21c 19.0.0.0.0 ",
...
TASK [racgi21c_install : Add oratab entry to first node] *********************************************************
changed: [192.168.56.102]

TASK [racgi21c_install : Add oratab entry to second node] ********************************************************
changed: [192.168.56.103]

TASK [racgi21c_install : Check CRS resources and status] *********************************************************
changed: [192.168.56.102]
...
TASK [racgi21c_install : Check cluster status] *******************************************************************
changed: [192.168.56.102]
...
TASK [racgi21c_install : Check ASM cluster mode] *****************************************************************
changed: [192.168.56.102]
...
TASK [racgi21c_install : bash_profile for user grid] *************************************************************
ok: [192.168.56.102]
ok: [192.168.56.103]

TASK [racgi21c_install : Remove stage directory] *****************************************************************
changed: [192.168.56.102] => (item=/u02/stage)
changed: [192.168.56.103] => (item=/u02/stage)

TASK [racgi21c_install : display post install message] ***********************************************************
ok: [192.168.56.102] => {
    "msg": [
